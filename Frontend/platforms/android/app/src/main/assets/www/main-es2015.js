...
const routes = [
    ...
    {
        path: 'tomar',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-tomar-tomar-module */ "pages-tomar-tomar-module").then(__webpack_require__.bind(null, /*! ./pages/tomar/tomar.module */ "./src/app/pages/tomar/tomar.module.ts")).then(m => m.TomarPageModule)
    },
    {
        path: 'escaner',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-escaner-escaner-module */ "pages-escaner-escaner-module").then(__webpack_require__.bind(null, /*! ./pages/escaner/escaner.module */ "./src/app/pages/escaner/escaner.module.ts")).then(m => m.EscanerPageModule)
    },
];
