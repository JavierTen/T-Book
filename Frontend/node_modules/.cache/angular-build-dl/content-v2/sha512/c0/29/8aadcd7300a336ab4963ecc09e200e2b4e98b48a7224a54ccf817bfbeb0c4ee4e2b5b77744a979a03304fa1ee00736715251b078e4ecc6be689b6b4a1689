...
const routes = [
    ...
    {
        path: 'categorias',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-categorias-categorias-module */ "pages-categorias-categorias-module").then(__webpack_require__.bind(null, /*! ./pages/categorias/categorias.module */ "./src/app/pages/categorias/categorias.module.ts")).then(m => m.CategoriasPageModule)
    },
    {
        path: 'busqueda',
    ...
    {
        path: 'reserva',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reserva-reserva-module */ "pages-reserva-reserva-module").then(__webpack_require__.bind(null, /*! ./pages/reserva/reserva.module */ "./src/app/pages/reserva/reserva.module.ts")).then(m => m.ReservaPageModule)
    },
    {
        path: 'historial',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-historial-historial-module */ "pages-historial-historial-module").then(__webpack_require__.bind(null, /*! ./pages/historial/historial.module */ "./src/app/pages/historial/historial.module.ts")).then(m => m.HistorialPageModule)
    },
    {
        path: 'multa',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-multa-multa-module */ "pages-multa-multa-module").then(__webpack_require__.bind(null, /*! ./pages/multa/multa.module */ "./src/app/pages/multa/multa.module.ts")).then(m => m.MultaPageModule)
    },
    {
        path: 'configuracion',
